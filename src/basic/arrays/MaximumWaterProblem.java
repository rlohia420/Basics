...
//leave this
/*
 * Given an array of N non-negative integers arr[] representing an elevation map where the width of 
 ...
 */
public class MaximumWaterProblem {
    ...
    {
        int arr[] = {2, 1, 3, 4, 6, 5};//{ 0, 1, 0, 2, 1, 0, 1, 3, 2, 1, 2, 1 };
        int N = arr.length;
